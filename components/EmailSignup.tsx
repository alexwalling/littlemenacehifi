...
export default function EmailSignup() {
  ...
  return (
    <div className="bg-black w-full py-24 px-8 text-center">
      <p className="text-[0.7rem] font-medium tracking-[0.25em] uppercase text-red-light mb-8">
        Stay Close
      </p>
      ...
      <p className="text-base font-light leading-[1.9] text-warm-gray-light max-w-[500px] mx-auto mb-10">
        No spam. Just a heads up when we&apos;re ready, and maybe a playlist or
        two before that.
      </p>
      <form
